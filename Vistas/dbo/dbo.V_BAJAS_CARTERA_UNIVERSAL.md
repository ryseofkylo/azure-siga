---
esquema: dbo
tabla: V_BAJAS_CARTERA_UNIVERSAL
objeto: dbo.V_BAJAS_CARTERA_UNIVERSAL
tipo_objeto: VIEW
...
```sql
-- Vista: dbo.V_BAJAS_CARTERA_UNIVERSAL
-- Extraida: 2026-08-07T15:27:38.131535+00:00
-- Fuente: sys.sql_modules / OBJECT_DEFINITION

CREATE VIEW [dbo].[V_BAJAS_CARTERA_UNIVERSAL]
...
where P.productoid in  (6411,6415,70041,70053,70075) OR (P.productoid in(8580,8581) AND P.EMPRESAID=23)
