---
esquema: dbo
tabla: V_ANALISISFAC_CONBAJAS_23
objeto: dbo.V_ANALISISFAC_CONBAJAS_23
tipo_objeto: VIEW
...
| 16 | `CONTRATOS_PM` | int | 4% |
| 17 | `SUMA_CON_PM` | bigint | 4% |
| 18 | `SUMA_POL_PM` | bigint | 4% |
| 19 | `SUMA_PRM_PM` | bigint | 4% |
| 20 | `CLASEPROD_PM` | int | 4% |
| 21 | `FACTURACION_PM` | float | 4% |
| 22 | `VARIA_COMPOSICION` | varchar | 0% |
| 23 | `VARIA_FACTURACION` | varchar | 0% |
| 24 | `FACT_EN_CERO` | varchar | 96% |
| 25 | `VARIA_POLITICA` | varchar | 0% |
| 26 | `ESTADO` | varchar | 96% |
| 27 | `IMPORTE_POL_PM` | float | 4% |
| 28 | `IMPORTE_PRM_PM` | float | 4% |
| 29 | `ESCALON_PM` | int | 4% |

## Definición (CREATE VIEW)
```sql
-- Vista: dbo.V_ANALISISFAC_CONBAJAS_23
-- Extraida: 2026-08-07T15:27:36.040380+00:00
-- Fuente: sys.sql_modules / OBJECT_DEFINITION

CREATE VIEW [dbo].[V_ANALISISFAC_CONBAJAS_23]
AS SELECT f.*,
	...
	FROM SIGASC.FACTURARESUMEN_23 f
	LEFT JOIN SIGASC.FACTURARESUMEN_23 c ON ( ( f.clientenro = c.clientenro ) AND ( f.periodoanterior = c.periodo ) );
```
