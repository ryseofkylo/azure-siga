---
esquema: dbo
tabla: V_BAJASPERIODO
objeto: dbo.V_BAJASPERIODO
tipo_objeto: VIEW
...
```sql
-- Vista: dbo.V_BAJASPERIODO
-- Extraida: 2026-08-07T15:27:39.465050+00:00
-- Fuente: sys.sql_modules / OBJECT_DEFINITION

CREATE VIEW [dbo].[V_BAJASPERIODO]
AS SELECT EMPRESAID, CLIENTENRO,
		   ...
		   0 AS IMPORTE_PRM,
		   0 AS ESCALON
	FROM SIGASC.FACTURACLIENTE c
	WHERE periodo NOT IN ( SELECT DISTINCT PERIODOANTERIOR from SIGASC.FACTURACLIENTE f where f.clientenro = c.clientenro );
```
