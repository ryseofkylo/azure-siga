---
esquema: dbo
tabla: V_BAJAS_CARTERA_PARAMOUNT
objeto: dbo.V_BAJAS_CARTERA_PARAMOUNT
tipo_objeto: VIEW
...
```sql
-- Vista: dbo.V_BAJAS_CARTERA_PARAMOUNT
-- Extraida: 2026-08-07T15:27:37.421361+00:00
-- Fuente: sys.sql_modules / OBJECT_DEFINITION

CREATE VIEW [dbo].[V_BAJAS_CARTERA_PARAMOUNT]
...
where (P.productoid in (6407,70052,6394, 70083, 6393) or ( P.productoid in (8554,6393,8790) and p.empresaid=23)) and P.PRODUCTOTPO = 'M'
),
