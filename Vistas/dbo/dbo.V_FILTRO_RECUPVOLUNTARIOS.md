---
esquema: dbo
tabla: V_FILTRO_RECUPVOLUNTARIOS
objeto: dbo.V_FILTRO_RECUPVOLUNTARIOS
tipo_objeto: VIEW
...
```sql
-- Vista: dbo.V_FILTRO_RECUPVOLUNTARIOS
-- Extraida: 2026-08-07T15:27:57.796717+00:00
-- Fuente: sys.sql_modules / OBJECT_DEFINITION

CREATE VIEW [dbo].[V_FILTRO_RECUPVOLUNTARIOS]
AS SELECT * FROM V_RECUPEROSVOLUNTARIOS
WHERE tipoprod NOT IN ( 'ADICIONAL ACCESORIO','DECODER','DECODER ANALOGICO','DERIVADO')
