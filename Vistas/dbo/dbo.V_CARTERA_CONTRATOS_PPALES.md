---
esquema: dbo
tabla: V_CARTERA_CONTRATOS_PPALES
objeto: dbo.V_CARTERA_CONTRATOS_PPALES
tipo_objeto: VIEW
...
```sql
-- Vista: dbo.V_CARTERA_CONTRATOS_PPALES
-- Extraida: 2026-08-07T15:27:41.486222+00:00
-- Fuente: sys.sql_modules / OBJECT_DEFINITION

CREATE VIEW [dbo].[V_CARTERA_CONTRATOS_PPALES]
...
--where P.productoid in (6402,6409,6418)
and P.PRODUCTOTPO IN ('B', 'Z', 'W','C', 'I', 'N', 'L', 'E')  
AND hc.contratosts = 'C'
AND p.PRODUCTOPPL = 'P'
),
