---
esquema: dbo
tabla: V_FACTURACION_2
objeto: dbo.V_FACTURACION_2
tipo_objeto: VIEW
...
| 11 | `FACTURAFCOB` | date | 6% |
| 12 | `FACTURAFICOB` | date | 6% |
| 13 | `FACTURAPRN` | int | 0% |
| 14 | `MEDCOBFAC` | int | 0% |
| 15 | `COBRADORID` | int | 0% |
...
| 29 | `FACTURAPRM` | int | 0% |
| 30 | `FACTURACMB` | int | 0% |
| 31 | `PRODUCTOID` | nvarchar | 1% |
| 32 | `FACTURACATPO` | varchar | 0% |
| 33 | `FACTURACC` | int | 0% |

## Definición (CREATE VIEW)
```sql
-- Vista: dbo.V_FACTURACION_2
-- Extraida: 2026-08-07T15:27:54.076908+00:00
-- Fuente: sys.sql_modules / OBJECT_DEFINITION

CREATE VIEW [V_FACTURACION_2]
AS SELECT f.EMPRESAID,																						-- EMPRESA
	  ...
	  ROUND(f.FACTURALINIMP, 2, 1) AS FACTURALINIMP,													-- IMPORTE LINEA FACTURA VTO 1
	   ...
	   ( f.pkproductoid ) AS PRODUCTOID,	--,
	   
FACTURACATPO, FACTURACC-- ID PRODUCTO	
