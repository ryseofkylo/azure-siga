---
esquema: dbo
tabla: vLeads_Ventas_Widget
objeto: dbo.vLeads_Ventas_Widget
tipo_objeto: VIEW
...
```sql
-- Vista: dbo.vLeads_Ventas_Widget
-- Extraida: 2026-08-07T15:28:31.395255+00:00
-- Fuente: sys.sql_modules / OBJECT_DEFINITION

CREATE VIEW [dbo].[vLeads_Ventas_Widget]
AS SELECT c.[Id] ,c.[Source],c.[Creation_date],c.[Close_date],c.[Client_id],c.[Client_crm_id],c.[Client_name],c.[Client_ext_id],c.[File],c.[FechaProcesado],c.[NroCliente],c.[Campaign],c.[Closed_by], p.producto, p.utm_source, p.utm_medium, p.utm_campaign, p.provincia, 'Ventas Widget' AS TipoLead
FROM sg_caso AS c
