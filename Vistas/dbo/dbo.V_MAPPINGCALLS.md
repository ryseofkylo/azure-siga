---
esquema: dbo
tabla: V_MAPPINGCALLS
objeto: dbo.V_MAPPINGCALLS
tipo_objeto: VIEW
...
```sql
-- Vista: dbo.V_MAPPINGCALLS
-- Extraida: 2026-08-07T15:28:00.797030+00:00
-- Fuente: sys.sql_modules / OBJECT_DEFINITION

CREATE VIEW [V_MAPPINGCALLS]
AS SELECT IDEVENTOS AS ID,
	   ...
	   GESTION
FROM MAPPING.CALLS
WHERE fecha >= CONVERT(VARCHAR(25),DATEADD(dd,-(DAY(DATEADD(mm,-13,GETDATE()))-1),DATEADD(mm,-13,GETDATE())),101);
```
