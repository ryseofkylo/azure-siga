---
esquema: dbo
tabla: vProyeccion_v2025-2
objeto: dbo.vProyeccion_v2025-2
tipo_objeto: VIEW
...
```sql
-- Vista: dbo.vProyeccion_v2025-2
-- Extraida: 2026-08-07T15:28:35.170653+00:00
-- Fuente: sys.sql_modules / OBJECT_DEFINITION

CREATE VIEW [dbo].[vProyeccion_v2025-2]
AS SELECT 
...
where [PERIODO] = CAST(FORMAT(DATEADD(MONTH, -2, GETDATE()), 'yyyyMM') AS INT)
AND [facturatpo]= 'F'
AND [facturagen]= 'M'
