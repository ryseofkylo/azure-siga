---
esquema: dbo
tabla: V_ORDENSRV_DESCONEX
objeto: dbo.V_ORDENSRV_DESCONEX
tipo_objeto: VIEW
...
| 8 | `ORDENFFIN` | datetime2 | 21% |
| 9 | `ORDENFPROCESO` | datetime2 | 36% |
...
```sql
-- Vista: dbo.V_ORDENSRV_DESCONEX
-- Extraida: 2026-08-07T15:28:09.147344+00:00
-- Fuente: sys.sql_modules / OBJECT_DEFINITION

CREATE VIEW [dbo].[V_ORDENSRV_DESCONEX]
AS SELECT 
