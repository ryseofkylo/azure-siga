---
esquema: dbo
tabla: V_ORDENSRV_RECLAMOS
objeto: dbo.V_ORDENSRV_RECLAMOS
tipo_objeto: VIEW
...
```sql
-- Vista: dbo.V_ORDENSRV_RECLAMOS
-- Extraida: 2026-08-07T15:28:09.822585+00:00
-- Fuente: sys.sql_modules / OBJECT_DEFINITION

CREATE VIEW [dbo].[V_ORDENSRV_RECLAMOS]
AS SELECT 
