---
esquema: dbo
tabla: vLeads_Boton_de_WhatsApp
objeto: dbo.vLeads_Boton_de_WhatsApp
tipo_objeto: VIEW
...
```sql
-- Vista: dbo.vLeads_Boton_de_WhatsApp
-- Extraida: 2026-08-07T15:28:27.116306+00:00
-- Fuente: sys.sql_modules / OBJECT_DEFINITION

CREATE VIEW [dbo].[vLeads_Boton_de_WhatsApp]
AS select c.[Id] ,c.[Source],c.[Creation_date],c.[Close_date],c.[Client_id],c.[Client_crm_id],c.[Client_name],c.[Client_ext_id],c.[File],c.[FechaProcesado],c.[NroCliente],c.[Campaign],c.[Closed_by], p.producto, p.utm_source, p.utm_medium, p.utm_campaign, p.provincia, 'Botón de WhatsApp' as TipoLead
from sg_caso c
