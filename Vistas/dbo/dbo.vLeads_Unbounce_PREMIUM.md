---
esquema: dbo
tabla: vLeads_Unbounce_PREMIUM
objeto: dbo.vLeads_Unbounce_PREMIUM
tipo_objeto: VIEW
...
```sql
-- Vista: dbo.vLeads_Unbounce_PREMIUM
-- Extraida: 2026-08-07T15:28:30.725000+00:00
-- Fuente: sys.sql_modules / OBJECT_DEFINITION

CREATE VIEW [dbo].[vLeads_Unbounce_PREMIUM]
AS select c.[Id] ,c.[Source],c.[Creation_date],c.[Close_date],c.[Client_id],c.[Client_crm_id],c.[Client_name],c.[Client_ext_id],c.[File], c.[FechaProcesado],c.[NroCliente],c.[Campaign],c.[Closed_by], p.producto, p.utm_source, p.utm_medium, p.utm_campaign, p.provincia, 'Unbounce PREMIUM' as TipoLead
from sg_caso c
