...
esquema: ACTIVITY
tabla: H_CONEXIONES
objeto: ACTIVITY.H_CONEXIONES
tipo_objeto: BASE TABLE
dominio: Actividad y Bajas
canonico: true
grain: 1 fila = 1 versión de `ORDENNRO` por `CONTRATOFING` — histórica/versionada (inferido de muestra)
n_columnas: 44
tags:
  - esquema/ACTIVITY
  - dominio/actividad-y-bajas
...
> **Grain (inferido):** 1 fila = 1 versión de `ORDENNRO` por `CONTRATOFING` — histórica/versionada (inferido de muestra)
...
| 38 | `IDPLANCOMERCIAL` | real | 97% |
| 39 | `PLANCOMERCIAL` | nvarchar | 97% |
