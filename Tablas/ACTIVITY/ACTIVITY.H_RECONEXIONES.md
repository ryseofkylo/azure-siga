---
esquema: ACTIVITY
tabla: H_RECONEXIONES
objeto: ACTIVITY.H_RECONEXIONES
tipo_objeto: BASE TABLE
dominio: Actividad y Bajas
canonico: true
grain: 1 fila = 1 versión de `ORDENNRO` por `ULTFECHADESCNEGOCIO` — histórica/versionada (inferido de muestra)
n_columnas: 45
tags:
  - esquema/ACTIVITY
  - dominio/actividad-y-bajas
...
> **Grain (inferido):** 1 fila = 1 versión de `ORDENNRO` por `ULTFECHADESCNEGOCIO` — histórica/versionada (inferido de muestra)
