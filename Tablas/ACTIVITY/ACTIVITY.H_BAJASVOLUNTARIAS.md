---
esquema: ACTIVITY
tabla: H_BAJASVOLUNTARIAS
objeto: ACTIVITY.H_BAJASVOLUNTARIAS
tipo_objeto: BASE TABLE
dominio: Actividad y Bajas
canonico: true
grain: 1 fila = 1 versión de `PRODUCTOID` por `FECHAINGRESO` — histórica/versionada (inferido de muestra)
n_columnas: 48
tags:
  - esquema/ACTIVITY
  - dominio/actividad-y-bajas
...
> **Grain (inferido):** 1 fila = 1 versión de `PRODUCTOID` por `FECHAINGRESO` — histórica/versionada (inferido de muestra)
