---
esquema: SIGASC
tabla: CLIENTESERVICIO_OPT2
objeto: SIGASC.CLIENTESERVICIO_OPT2
...
| 10 | `CLIENTESRVFAGE` | datetime2 | 50% |
| 11 | `CLIENTESRVFACFCH` | datetime2 | 98% |
...
| 43 | `CLIENTESRVOBSERVACION` | varchar | 4% |
| 44 | `CLIENTESRVARTICULOID` | int | 0% |
| 45 | `CLIENTESERVICIOBARRIO` | int | 22% |
| 46 | `CLIENTESRVMEDIOCOBROID` | int | 46% |
| 47 | `CLIENTESRVPROYECTOSAP` | int | 62% |
