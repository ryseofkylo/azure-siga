---
esquema: SIGASC
tabla: CLIENTESERVICIO_OPT
objeto: SIGASC.CLIENTESERVICIO_OPT
tipo_objeto: BASE TABLE
dominio: Core SIGA
canonico: true
grain: 1 fila = 1 `CLIENTESRVNRO` (único en muestra de 200)
n_columnas: 49
tags:
  - esquema/SIGASC
  - dominio/core-siga
...
> **BASE TABLE** · Dominio: **Core SIGA** · 49 columnas · Consultá esta tabla directamente (**tabla-first**).
> **Grain (inferido):** 1 fila = 1 `CLIENTESRVNRO` (único en muestra de 200)

## Columnas
| # | Columna | Tipo | %null (m) |
|--:|---|---|--:|
| 1 | `EMPRESAID` | int | 0% |
| 2 | `CLIENTESRVNRO` | varchar | 0% |
| 3 | `SERVICIOID` | int | 0% |
| 4 | `CLIENTESRVCONTRATO` | varchar | 0% |
...
| 10 | `CLIENTESRVFAGE` | datetime2 | 48% |
| 11 | `CLIENTESRVFACFCH` | datetime2 | 96% |
| 12 | `CLISRVMOTORDID` | int | 0% |
| 13 | `CLIENTENRO` | varchar | 0% |
| 14 | `CLIENTESRVCANTIDAD` | int | 0% |
| 15 | `SERVICIOTARIFAID` | int | 0% |
| 16 | `CUOTAID` | int | 0% |
| 17 | `CLIENTESRVPRC` | float | 0% |
...
| 36 | `CLIENTESRVCXLFCH` | datetime2 | 90% |
...
| 43 | `CLIENTESRVOBSERVACION` | varchar | 1% |
| 44 | `CLIENTESRVARTICULOID` | int | 0% |
| 45 | `CLIENTESERVICIOBARRIO` | int | 16% |
| 46 | `CLIENTESRVMEDIOCOBROID` | int | 48% |
| 47 | `CLIENTESRVPROYECTOSAP` | int | 72% |
| 48 | `BDMODIFIEDDATE` | datetime2 | 0% |
| 49 | `PIPELINERUNID` | varchar | 0% |
