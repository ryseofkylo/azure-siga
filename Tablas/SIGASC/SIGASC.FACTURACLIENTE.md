...
**Filtros**
- `periodo NOT IN ( SELECT DISTINCT PERIODOANTERIOR from SIGASC.FACTURACLIENTE f where f.clientenro = c.clientenro )` — _de_ [[dbo.V_BAJASPERIODO]]
- ♻️ dedup: vistas que deduplican esta tabla → [[dbo.V_BAJASPERIODO]]
