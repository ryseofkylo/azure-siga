---
esquema: SIGASC
tabla: CLIENTESERVICIO_OPT_changed
objeto: SIGASC.CLIENTESERVICIO_OPT_changed
...
| 10 | `CLIENTESRVFAGE` | datetime2 | 40% |
...
| 36 | `CLIENTESRVCXLFCH` | datetime2 | 92% |
...
| 45 | `CLIENTESERVICIOBARRIO` | int | 1% |
| 46 | `CLIENTESRVMEDIOCOBROID` | int | 1% |
| 47 | `CLIENTESRVPROYECTOSAP` | int | 100% |
