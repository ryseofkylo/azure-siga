---
esquema: MKT
tabla: NPS_202604_TIC
objeto: MKT.NPS_202604_TIC
tipo_objeto: BASE TABLE
dominio: Marketing
canonico: true
grain: 1 fila = 1 `Clientenro` (único en muestra de 107)
n_columnas: 35
tags:
  - esquema/MKT
  - dominio/marketing
...
> **Grain (inferido):** 1 fila = 1 `Clientenro` (único en muestra de 107)
...
| 14 | `Mas_Satisfecho_Precio` | int | 82% |
| 15 | `Mas_Satisfecho_Producto` | int | 81% |
| 16 | `Mas_Satisfecho_Atención_al_cliente` | int | 93% |
| 17 | `Mas_Satisfecho_Servicio_Técnico` | int | 87% |
| 18 | `Qué_debemos_mejorar` | int | 63% |
| 19 | `Aspectos_precio_mejora_Aumentos` | int | 89% |
| 20 | `Aspectos_precio_mejora_Precio_no_coincide` | int | 96% |
| 21 | `Aspectos_precio_mejora_FinPromo_Precio_MuyAlto` | int | 90% |
| 22 | `Aspectos_precio_mejora_alternativas_economicas` | int | 91% |
| 23 | `Aspectos_producto_mejora_veloc_internet` | int | 92% |
| 24 | `Aspectos_producto_mejora_corte_internet` | int | 93% |
| 25 | `Aspectos_producto_mejora_Senial_TV` | int | 94% |
| 26 | `Aspectos_producto_mejora_Cantidad_Senial_TV` | int | 97% |
