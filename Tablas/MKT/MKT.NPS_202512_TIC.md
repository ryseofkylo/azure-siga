---
esquema: MKT
tabla: NPS_202512_TIC
objeto: MKT.NPS_202512_TIC
...
| 14 | `Mas_Satisfecho_Precio` | int | 86% |
| 15 | `Mas_Satisfecho_Producto` | int | 83% |
| 16 | `Mas_Satisfecho_Atención_al_cliente` | int | 92% |
| 17 | `Mas_Satisfecho_Servicio_Técnico` | int | 94% |
| 18 | `Qué_debemos_mejorar` | int | 52% |
...
| 22 | `Aspectos_precio_mejora_alternativas_economicas` | int | 86% |
| 23 | `Aspectos_producto_mejora_veloc_internet` | int | 83% |
| 24 | `Aspectos_producto_mejora_corte_internet` | int | 90% |
| 25 | `Aspectos_producto_mejora_Senial_TV` | int | 97% |
| 26 | `Aspectos_producto_mejora_Cantidad_Senial_TV` | int | 92% |
...
| 29 | `Mejora_Atencion_Cliente_Trato_por_parte_del_personal_de_la_Sucursal` | int | 100% |
