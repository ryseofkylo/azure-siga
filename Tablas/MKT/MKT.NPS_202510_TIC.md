---
esquema: MKT
tabla: NPS_202510_TIC
objeto: MKT.NPS_202510_TIC
...
| 19 | `Aspectos_precio_mejora_Aumentos` | int | 90% |
...
| 26 | `Aspectos_producto_mejora_Cantidad_Senial_TV` | int | 91% |
| 27 | `Mejora_Atencion_Cliente_Comuniación_con_Atención_al_cliente` | int | 99% |
| 28 | `Mejora_Atencion_Cliente_Resolución_de_problemas_durante_la_consulta` | int | 100% |
...
| 35 | `Te_gustaría_dejarnos_algún_cometario_adicional` | nvarchar | 46% |
