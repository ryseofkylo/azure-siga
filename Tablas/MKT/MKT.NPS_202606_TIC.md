---
esquema: MKT
tabla: NPS_202606_TIC
objeto: MKT.NPS_202606_TIC
tipo_objeto: BASE TABLE
dominio: Marketing
canonico: true
grain: 1 fila = 1 `Clientenro` (único en muestra de 190)
n_columnas: 35
tags:
  - esquema/MKT
  - dominio/marketing
...
> **Grain (inferido):** 1 fila = 1 `Clientenro` (único en muestra de 190)
...
| 15 | `Mas_Satisfecho_Producto` | int | 84% |
| 16 | `Mas_Satisfecho_Atención_al_cliente` | int | 88% |
| 17 | `Mas_Satisfecho_Servicio_Técnico` | int | 89% |
| 18 | `Qué_debemos_mejorar` | int | 54% |
| 19 | `Aspectos_precio_mejora_Aumentos` | int | 93% |
| 20 | `Aspectos_precio_mejora_Precio_no_coincide` | int | 98% |
| 21 | `Aspectos_precio_mejora_FinPromo_Precio_MuyAlto` | int | 88% |
| 22 | `Aspectos_precio_mejora_alternativas_economicas` | int | 92% |
| 23 | `Aspectos_producto_mejora_veloc_internet` | int | 89% |
| 24 | `Aspectos_producto_mejora_corte_internet` | int | 93% |
| 25 | `Aspectos_producto_mejora_Senial_TV` | int | 95% |
| 26 | `Aspectos_producto_mejora_Cantidad_Senial_TV` | int | 98% |
| 27 | `Mejora_Atencion_Cliente_Comuniación_con_Atención_al_cliente` | int | 97% |
...
| 32 | `Mejora_Servicio_Tecnico_Solución_de_inconveniente` | int | 95% |
| 33 | `Mejora_Servicio_Tecnico_Trato_por_parte_del_personal_de_Servicio_Técnico` | int | 100% |
| 34 | `Mejora_Servicio_Tecnico_Prolijidad_y_limpieza_al_finalizar_el_trabajo` | int | 99% |
| 35 | `Te_gustaría_dejarnos_algún_cometario_adicional` | nvarchar | 45% |
