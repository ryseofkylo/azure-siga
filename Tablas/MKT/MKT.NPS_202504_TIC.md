---
esquema: MKT
tabla: NPS_202504_TIC
objeto: MKT.NPS_202504_TIC
...
| 15 | `Mas_Satisfecho_Producto` | int | 81% |
| 16 | `Mas_Satisfecho_Atención_al_cliente` | int | 90% |
| 17 | `Mas_Satisfecho_Servicio_Técnico` | int | 89% |
| 18 | `Qué_debemos_mejorar` | int | 56% |
...
| 23 | `Aspectos_producto_mejora_veloc_internet` | int | 93% |
| 24 | `Aspectos_producto_mejora_corte_internet` | int | 94% |
| 25 | `Aspectos_producto_mejora_Senial_TV` | int | 98% |
| 26 | `Aspectos_producto_mejora_Cantidad_Senial_TV` | int | 96% |
| 27 | `Mejora_Atencion_Cliente_Comuniación_con_Atención_al_cliente` | int | 96% |
