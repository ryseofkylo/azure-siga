---
objeto: clave-CLIENT_EXT_ID
tipo_objeto: CLAVE DE JOIN
columna: CLIENT_EXT_ID
tipos:
  - nvarchar
n_tablas: 25
confidence: baja
...
# Clave de join: `CLIENT_EXT_ID`

> Columna homónima (tipo nvarchar) presente en **25 tablas canónicas**. Candidata de JOIN — confidence **baja** (por nombre+tipo, no declarada).
