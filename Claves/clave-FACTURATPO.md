...
# Clave de join: `FACTURATPO`

> Columna homónima (tipo nvarchar, varchar) presente en **33 tablas canónicas**. Candidata de JOIN — confidence **baja** (por nombre+tipo, no declarada).
